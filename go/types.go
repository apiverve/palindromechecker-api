// Package palindromechecker provides a Go client for the Palindrome Checker API.
//
// For more information, visit: https://apiverve.com/marketplace/palindromechecker?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Palindrome Checker API.
//
// Parameters:
//   - text (required): string - The text to check for palindrome
//   - ignorecase: boolean - Ignore case when checking (default: true)
//   - ignorespaces: boolean - Ignore spaces when checking (default: true)
//   - ignorepunctuation: boolean - Ignore punctuation when checking (default: true)
type Request struct {
	Text string `json:"text"` // Required
	Ignorecase bool `json:"ignorecase,omitempty"` // Optional
	Ignorespaces bool `json:"ignorespaces,omitempty"` // Optional
	Ignorepunctuation bool `json:"ignorepunctuation,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"ignorepunctuation": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Palindrome Checker API.
type ResponseData struct {
	Text string `json:"text"`
	IsPalindrome bool `json:"is_palindrome"`
	CleanedText string `json:"cleaned_text"`
	ReversedText string `json:"reversed_text"`
	Length int `json:"length"`
	Options OptionsData `json:"options"`
	LongestPalindromeSubstring string `json:"longest_palindrome_substring"`
	LongestPalindromeLength int `json:"longest_palindrome_length"`
}
