...
{
    class PalindromeCheckerExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/palindromechecker";

        /// <summary>
        /// Make a GET request to the Palindrome Checker API
        /// </summary>
        static async Task<JsonDocument> CallPalindromeCheckerAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;text&quot;] &#x3D; &quot;A man a plan a canal Panama&quot;, [&quot;ignorecase&quot;] &#x3D; true, [&quot;ignorespaces&quot;] &#x3D; true, [&quot;ignorepunctuation&quot;] &#x3D; true };
        ...
        {
            Console.WriteLine("📤 Calling Palindrome Checker API...\n");

            var result = await CallPalindromeCheckerAPI();
