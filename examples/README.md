# Palindrome Checker API - Examples

This folder contains example code for using the Palindrome Checker API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/palindromechecker',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/palindromechecker");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/palindromechecker](https://docs.apiverve.com/ref/palindromechecker)
