# Palindrome Checker Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:palindromechecker-api:1.1.13'
}
```
...
```java
import com.apiverve.palindromechecker.PalindromeCheckerAPIClient;
import com.apiverve.palindromechecker.APIResponse;
import com.apiverve.palindromechecker.APIException;

// Initialize the client
PalindromeCheckerAPIClient client = new PalindromeCheckerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "A man a plan a canal Panama");
    parameters.put("ignorecase", true);
    parameters.put("ignorespaces", true);
    parameters.put("ignorepunctuation", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/palindromechecker](https://docs.apiverve.com/ref/palindromechecker)
...
- **Documentation:** [https://docs.apiverve.com/ref/palindromechecker](https://docs.apiverve.com/ref/palindromechecker)
- **Issues:** [GitHub Issues](https://github.com/apiverve/palindromechecker-api/issues)
