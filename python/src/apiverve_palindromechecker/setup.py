...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/palindromechecker',
        'Source': 'https://github.com/apiverve/palindromechecker-api',
        'Bug Tracker': 'https://github.com/apiverve/palindromechecker-api/issues'
    },
    classifiers=[
