...
class palindromecheckerWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/palindromechecker');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"ignorecase":{"type":"boolean","required":false,"default":true},"ignorespaces":{"type":"boolean","required":false,"default":true},"ignorepunctuation":{"type":"boolean","required":false,"default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/palindromechecker`);
        }
    }
...
module.exports = palindromecheckerWrapper;
