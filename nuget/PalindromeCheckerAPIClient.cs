...
namespace APIVerve.API.PalindromeChecker
{
    ...
    /// <summary>
    /// Client for the PalindromeChecker API
    /// </summary>
    public class PalindromeCheckerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/palindromechecker";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "ignorepunctuation", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public PalindromeCheckerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PalindromeCheckerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PalindromeCheckerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PalindromeCheckerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PalindromeCheckerQueryOptions options)
        {
        ...
        public ResponseObj Execute(PalindromeCheckerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PalindromeCheckerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PalindromeCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PalindromeCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PalindromeCheckerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PalindromeCheckerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PalindromeCheckerQueryOptions options)
        {
